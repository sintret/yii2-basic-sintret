...
{
$model = new Test();
$model->createDate = date("Y-m-d H:i:s");$model->userCreate = Yii::$app->user->id;$model->userUpdate = Yii::$app->user->id;if ($model->loadWithFiles(Yii::$app->request->post()) && $model->save()) {
...
{
$model = $this->findModel($id);
$model->userCreate = Yii::$app->user->id;$model->userUpdate = Yii::$app->user->id;if ($model->loadWithFiles(Yii::$app->request->post()) && $model->save()) {
...
$notification->title = 'parsing Test';
$notification->message = Yii::$app->user->identity->username . ' parsing Test ';
$notification->params = \yii\helpers\Json::encode(['model' => 'Test', 'id' => $model->id]);
$notification->save();
}
}
$route = 'test/parsing-log';
