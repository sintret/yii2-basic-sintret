...
$this->title='Parsing / Upload  my_session excel';
$this->params['breadcrumbs'][] = ['label' => 'my_session', 'url' => ['index']];
...
<div class="sintret-update">
    ...
    <div class="page-header">
        <h1>Parsing Excel my_session</h1>
    </div>


    <div class="my_session-form">
    ...
    <div class="row">
        <div class="col-md-10">
            Format Sample : <a href="<?php echo Yii::$app->urlManager->createUrl('my-session/sample');?>">my-session.xls</a>
        </div>
