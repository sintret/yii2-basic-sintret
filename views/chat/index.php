...
<?php 
     $toolbars = [
        ['content' =>
            Html::a('<i class="glyphicon glyphicon-plus"></i>', ['chat/create'], ['type' => 'button', 'title' => 'Add ' . $this->title, 'class' => 'btn btn-success']) . ' ' .
            Html::a('<i class="fa fa-file-excel-o"></i>', ['chat/parsing'], ['type' => 'button', 'title' => 'Parsing Excel ' . $this->title, 'class' => 'btn btn-warning']) . ' ' .
            ...
            Html::a('<i class="glyphicon glyphicon-repeat"></i>', ['chat/index','p_reset'=>true], ['data-pjax' => 0, 'class' => 'btn btn-default', 'title' => 'Reset Grid']). ' '
    ...
    $dynagrid = DynaGrid::begin([
                ...
                'options' => ['id' => 'Chat'.Yii::$app->user->identity->id] // a unique identifier is important
    ]);
...
if(array==""){
    ...
    if(window.confirm("Are You Sure to delete selected data?")){
        $.ajax({
            type:"POST",
            url:"'.Yii::$app->urlManager->createUrl(['chat/delete-all']).'",
            data :{pk:array},
            success:function(){
                location.href="";
            }
