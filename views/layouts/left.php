    ...
    <section class="sidebar">
        ...
        Nav::widget(
                [
                    ...
                    'items' => [
                        '<li class="header">Sintret Maintenance</li>',
                        [
        ...
        <?php if (app\controllers\CController::checkManyAccess(['setting.index', 'role.index'], Yii::$app->user->identity->roleId)) { ?>
            <ul class="sidebar-menu">
                <li class="treeview">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                        <?php if (app\controllers\CController::checkAccess("setting.index", Yii::$app->user->identity->roleId)) { ?>
                            <li><a href="<?= \yii\helpers\Url::to(['/setting/update', 'id' => 1]) ?>"><span class="fa fa-cog"></span> General</a>
                            </li>
                        <?php } ?>
                        <?php if (app\controllers\CController::checkAccess("role.index", Yii::$app->user->identity->roleId)) { ?>
